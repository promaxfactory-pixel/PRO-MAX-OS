  ...
  return (
    <div id="print-area">
      <div className="print-header">
        ...
        <div>
          <div className="doc-title">سند قبض</div>
      ...
      <div className="info-grid">
        ...
        <div><span className="label">المبلغ: </span><span className="value" style={{ fontWeight: 700, fontSize: 14, color: "#059669" }}>{formatOMR(payment.amount_milli)}</span></div>
